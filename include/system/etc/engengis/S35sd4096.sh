...
if [ -e /sys/devices/virtual/bdi/0:18/read_ahead_kb ]; then
	echo "4096" > /sys/devices/virtual/bdi/0:18/read_ahead_kb
fi
...
if [ -e /sys/devices/virtual/bdi/179:28/read_ahead_kb ]; then
	echo "4096" > /sys/devices/virtual/bdi/179:28/read_ahead_kb;
fi

if [ -e /sys/devices/virtual/bdi/179:33/read_ahead_kb ]; then
	echo "4096" > /sys/devices/virtual/bdi/179:33/read_ahead_kb;
fi
